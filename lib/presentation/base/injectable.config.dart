...
import 'package:btp/data/cache/database/dao/driver_dao.dart' as _i32;
import 'package:btp/data/cache/database/dao/users_dao.dart' as _i31;
import 'package:btp/data/cache/database/local_database.dart' as _i29;
import 'package:btp/data/network/service/firebase_service.dart' as _i6;
import 'package:btp/data/network/service/retrofit_service.dart' as _i30;
...
import 'package:btp/data/repositories/rider_booking_repository.dart' as _i22;
import 'package:btp/data/repositories/rider_home_repository.dart' as _i24;
import 'package:btp/data/repositories/rider_rides_repository.dart' as _i26;
import 'package:btp/data/repositories/splash_repository.dart' as _i28;
import 'package:btp/domain/di/app_module.dart' as _i33;
import 'package:btp/domain/di/cache_module.dart' as _i34;
import 'package:btp/domain/di/network_module.dart' as _i35;
...
import 'package:btp/domain/repositories/i_rider_booking_repository.dart'
    as _i21;
import 'package:btp/domain/repositories/i_rider_home_repository.dart' as _i23;
import 'package:btp/domain/repositories/i_rider_rides_repository.dart' as _i25;
import 'package:btp/domain/repositories/i_splash_repository.dart' as _i27;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i21.IRiderBookingRepository>(
        () => _i22.RiderBookingRepository());
    gh.factory<_i23.IRiderHomeRepository>(() => _i24.RiderHomeRepository());
    gh.factory<_i25.IRiderRidesRepository>(() => _i26.RiderRidesRepository());
    gh.factory<_i27.ISplashRepository>(() => _i28.SplashRepository());
    await gh.factoryAsync<_i29.LocalDatabase>(
      () => cacheModule.localDatabase,
      preResolve: true,
    );
    gh.factory<_i30.RestClient>(() => networkModule.restClient);
    gh.factory<_i31.UsersDao>(
        () => cacheModule.usersDao(gh<_i29.LocalDatabase>()));
    gh.factory<_i32.DriverDao>(
        () => cacheModule.adsRulesDao(gh<_i29.LocalDatabase>()));
    return this;
  }
}
...
class _$CacheModule extends _i34.CacheModule {}
