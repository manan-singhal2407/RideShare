...
import 'package:btp/data/cache/database/dao/driver_dao.dart' as _i36;
import 'package:btp/data/cache/database/dao/users_dao.dart' as _i35;
import 'package:btp/data/cache/database/local_database.dart' as _i33;
import 'package:btp/data/network/service/firebase_service.dart' as _i6;
import 'package:btp/data/network/service/retrofit_service.dart' as _i34;
...
import 'package:btp/data/repositories/rider_rides_repository.dart' as _i30;
import 'package:btp/data/repositories/splash_repository.dart' as _i32;
import 'package:btp/domain/di/app_module.dart' as _i37;
import 'package:btp/domain/di/cache_module.dart' as _i38;
import 'package:btp/domain/di/network_module.dart' as _i39;
...
import 'package:btp/domain/repositories/i_rider_rides_repository.dart' as _i29;
import 'package:btp/domain/repositories/i_splash_repository.dart' as _i31;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i29.IRiderRidesRepository>(() => _i30.RiderRidesRepository());
    gh.factory<_i31.ISplashRepository>(() => _i32.SplashRepository());
    await gh.factoryAsync<_i33.LocalDatabase>(
      () => cacheModule.localDatabase,
      preResolve: true,
    );
    gh.factory<_i34.RestClient>(() => networkModule.restClient);
    gh.factory<_i35.UsersDao>(
        () => cacheModule.usersDao(gh<_i33.LocalDatabase>()));
    gh.factory<_i36.DriverDao>(
        () => cacheModule.adsRulesDao(gh<_i33.LocalDatabase>()));
    return this;
  }
}
...
class _$CacheModule extends _i38.CacheModule {}
